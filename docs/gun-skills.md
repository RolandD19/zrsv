...
1 | Rolling Start | After standing still for 1 second, gain +30% movement speed for 2 seconds
2 | Run and Gun | You can now shoot this weapon while sprinting.
2 | Flank Master | If you are undetected, or not in the viewing cone of an enemy, you will receive a 15% damage boost.
2 | Emergency Sprint | After switching to this weapon, your movement speed will increase by 20% for 3 seconds.
3 | Crosshair Myopia | Increases the radius of the circle in which the cursor must stay to avoid glancing shots.
3 | First Bullet | The first bullet of each magazine deals 30% more damage.
3 | Reload Artist: Speed Reload | Double-press the reload button to speed up the reload process of magazine-fed weapons, but any ammunition already in the magazine will be lost.
...
2 | Empowered Backup | For 2.5 seconds after swapping to this weapon, all shots will have 15% increased damage.
2 | Fast Hands | Switching to this type of weapon is 50% faster.
2 | Prolonged Vision | When you hit a target they will remain visible for 2 seconds when going out of sight.
2 | Flank Master | If you are undetected, or not in the viewing cone of an enemy, you will receive a 15% damage boost.
2 | Rolling Start | After standing still for 1 second, gain +30% movement speed for 2 seconds
3 | Run and Gun | You can now shoot this weapon while sprinting.
3 | Impaler shot | Hitting an enemy will decrease its speed by 30% for 1 second.
3 | Killer Reload | Increase reload speed by 20% for 1.5 seconds after killing an enemy.
...
1 | Crosshair Myopia | Increases the radius of the circle in which the cursor must stay to avoid glancing shots.
1 | Rolling Start | After standing still for 1 second, gain +30% movement speed for 2 seconds
2 | Killer Reload | Increase reload speed by 20% for 1.5 seconds after killing an enemy.
2 | Impaler shot | Hitting an enemy will decrease its speed by 30% for 1 second.
2 | Reload Artist: Speed Reload | Double-press the reload button to speed up the reload process of magazine-fed weapons, but any ammunition already in the magazine will be lost.
2 | Point Blank | Full hits have an additional 20% chance to penetrate armor.
3 | Run and Gun | You can now shoot this weapon while sprinting.
3 | Shotgun Master | If using Slug ammunition the maximum effective range is increased.
...
1 | Fast Focus | Hover over the target with the cursor to make the cross-hair shrink more quickly.
1 | Reload Artist: Speed Reload | Double-press the reload button to speed up the reload process of magazine-fed weapons, but any ammunition already in the magazine will be lost.
1 | Improvised Sniper | Hovering over the target with the cursor for 1 second will increase the maximum effective range of the weapon for that shot.
...
2 | Impaler shot | Hitting an enemy will decrease its speed by 30% for 1 second.
2 | Close Quarters Training | Minimum effective range of this weapon is reduced by 40%.
2 | Killer Reload | Increase reload speed by 20% for 1.5 seconds after killing an enemy.
2 | Flank Master | If you are undetected, or not in the viewing cone of an enemy, you will receive a 15% damage boost.
...
2 | Steady Sniper | After hitting an enemy while scoped, the optic cross-hair will have double the Ergonomics statistic for 2 seconds.
2 | Fast Focus | Hover over the target with the cursor to make the cross-hair shrink more quickly.
2 | Crosshair Myopia | Increases the radius of the circle in which the cursor must stay to avoid glancing shots.
3 | Fast Hands | Switching to this type of weapon is 50% faster.
3 | Close Quarters Training | Minimum effective range of this weapon is reduced by 40%.
3 | Reload Artist: Speed Reload | Double-press the reload button to speed up the reload process of magazine-fed weapons, but any ammunition already in the magazine will be lost.
3 | Flank Master | If you are undetected, or not in the viewing cone of an enemy, you will receive a 15% damage boost.
4 | Penetrating Shot | A killing shot will result in the bullet continuing on its path to hit a target behind the first.
4 | First Bullet | The first bullet of each magazine deals 30% more damage.
...
1 | Fast Focus | Hover over the target with the cursor to make the cross-hair shrink more quickly.
1 | Marksman Awareness | When using this weapon while scoped, you will be able to partially see the area beyond the reticle interface, while the cross-hair will also be instantly visible.
1 | Steady Sniper | After hitting an enemy while scoped, the optic cross-hair will have double the Ergonomics statistic for 2 seconds.
2 | Flank Master | If you are undetected, or not in the viewing cone of an enemy, you will receive a 15% damage boost.
2 | Impaler shot (sniper) | Hit an enemy will decrease its speed by 30% for 2 seconds.
2 | Prolonged Vision | When you hit a target they will remain visible for 2 seconds when going out of sight.
2 | Fast Hands | Switching to this type of weapon is 50% faster.
2 | Vital Shooting | By hovering over a target with your cursor for a short time before shooting, the shot will ignore some of its armor.
3 | First Bullet | The first bullet of each magazine deals 30% more damage.
3 | Penetrating Shot | A killing shot will result in the bullet continuing on its path to hit a target behind the first.
3 | Close Quarters Training | Minimum effective range of this weapon is reduced by 40%.
